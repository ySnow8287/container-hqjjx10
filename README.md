...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hqjjx10.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hqjjx10.containers.anotherwebservice.com/
...
```
git clone git@github.com:ySnow8287/container-hqjjx10.git
cd container-hqjjx10
```
...
```
docker attach container-hqjjx10
```
